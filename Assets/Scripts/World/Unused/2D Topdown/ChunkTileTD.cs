...
public class ChunkTileTD : MonoBehaviour {
    ...
    private static List<ChunkTileTD> chunkData = new List<ChunkTileTD>();
    ...
    public static ChunkTileTD GetChunk(Vector3 pos) {        
